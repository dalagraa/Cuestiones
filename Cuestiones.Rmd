...
caracter_repetido_30 <- caracteres_repetidos(texto, 30)

if (length(caracter_repetido_30) > 0) {
  print(paste("El carácter que se repite exactamente 30 veces en el texto es:", caracter_repetido_30))
} else {
  print("No hay ningún carácter que se repita exactamente 30 veces en el texto.")
}
